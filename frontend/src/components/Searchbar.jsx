...
function Searchbar() {
    ...
    return (
        <div className="bg-gray-900">
            ...
            {/* Recipe Tiles */}
            <div className="p-20 bg-gray-100 dark:bg-gray-800">
                {recipes.length > 0 ? (
                    recipes.map((recipe) => (
                        <div
                            key={recipe.id}
                            className="max-w-sm p-6 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700"
                        >
                            <a href="#">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">No recipes found.</p>
                )}
            </div>
        </div>
    )
